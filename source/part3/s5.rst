...
.. answer::
    ...
    .. math::
        ...
        \approx 10^3\cdotI(M) + 10^6\cdotS(M)
    ...
    For ``BinarySearchST`` it gives :math:`10^3\cdot 2 \cdot M + 10^6\cdot\log(M)` worst case,  :math:`10^3\cdotM + 10^6\cdot\log(M)` average case.
